define(function(require, exports, module) {
	...
	module.exports = Rule.extend(function() {
		...
		['~', '!', '%', '^', '&&', '&', '*', '(', ')', '--', '-', '++', '+', '===', '==', '=', '[', ']', '{', '}', '||', '|', '\\', '<<', '>>', '<', '>', ',', '.', '?', ':', ';', '/'].forEach(function(o) {
			self.addMatch(new CompleteEqual(Token.SIGN, o, Lexer.IS_PERL_REG));
		});
	}).statics({
		KEYWORDS: KEYWORDS
	});
